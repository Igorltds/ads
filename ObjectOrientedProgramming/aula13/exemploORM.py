...
print('-'*30)
d = session.query(Funcionario).filter(Funcionario.idade == 22 and Funcionario.nome.like('%inho%'))
for i in d:
    print(i.id, i.nome, i.idade, i.salario)
...
print('-'*30)
d = session.query(Funcionario).filter(Funcionario.idade == 22 and Funcionario.nome.like('%inho%')).first()
