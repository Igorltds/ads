...
fila=[]
fila = enfileirar(fila, "amarelo")
fila = enfileirar(fila, 'branco')
fila = enfileirar(fila, 'verde')
fila = enfileirar(fila, 'vermelho')
item = desenfileirar(fila)
item = desenfileirar(fila)
fila = enfileirar(fila, 'azul')
item = desenfileirar(fila)
fila = enfileirar(fila, item)
print(fila)